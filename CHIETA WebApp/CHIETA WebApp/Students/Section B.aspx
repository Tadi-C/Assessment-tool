...
<script>
    ...
    const questions = [
        {
            question: "Calender based maintenance can also be described as:",
            options: ["Keep a record of maintenance word done.", "Capturing data for health and safety purpose", "Storage of reliable data for future analysis", "Budgetary purposes"]
        },
        {
            question: "Calender based maintenance can also be described as:",
            options: ["Keep a record of maintenance word done.", "Capturing data for health and safety purpose", "Storage of reliable data for future analysis", "Budgetary purposes"]
