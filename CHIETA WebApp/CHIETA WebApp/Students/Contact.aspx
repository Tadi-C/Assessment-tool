<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="CHIETA_WebApp.Students.Contact" %>
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="row">
                            <div  style="width:100%">
                                  <div class="card">
                <div class="card-body">
                  <h6 style="color:#CA8A1C">Available contact</h6>
                    ...
                    <table style="width:100%;border-collapse" >
                      ...
                      <tbody>
                        <tr >
                          ...
                          <td><button style="background-color: #412151;border-width: 0px; color: white; border-radius: 10px;height: 30px">View</button></td>
                        </tr>
                        <tr>
                            <td>Agriculturial scientist</td>
                          <td><button style="background-color: #412151;border-width: 0px; color: white; border-radius: 10px;height: 30px">View</button></td>
                        </tr>
                        <tr>
